Here’s the updated form documentation for the **Gourmet Nexus** project, with the **Live Chat Form** removed:

---

# Form Documentation for Gourmet Nexus Project
...
### Additional Notes:
- **Social login form**: Implemented via third-party integrations (e.g., Google, Facebook) and will only request necessary permissions such as email and name.

---

This is the final documentation for all forms used in the **Gourmet Nexus** project. Let me know if there’s anything else you need!
